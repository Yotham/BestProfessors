...
describe(About, () => {
  it('About displays correct information', () => {
    ...
    expect(pageValue).toEqual('A group of RPI students dedicated to making the class selection process easier,'+
     ' our mission was to eliminate the need to sift through RateMyProfessor to find professor ratings and' +
     'instead allow students to enter their course code and receive all the necessary information.');
  });
